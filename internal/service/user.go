...
func NewUserService(repo *repository.UserRepo, jwtSecret string, expiresIn time.Duration) *UserService {
	return &UserService{repo: repo, jwtSecret: []byte(jwtSecret), expiresIn: expiresIn}
}
